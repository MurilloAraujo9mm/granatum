...
/**
 * PHP | Class Model Layer Supertype Pattern
 *
...
abstract class Model
{
     ...
     */
    public function findById(string $name_id, int $id, string $columns = "*"): ?Model
    {
        $find = $this->find("{$name_id} = :{$name_id}", "{$name_id}={$id}", $columns);
        return $find->fetch();
    }
    ...
    public function save(): bool
    {
        ...
        $this->data = $this->findById("id",$id)->data();
        return true;
    }
